        ...
        <div class="flex flex-col flex-1 w-0 overflow-hidden">
          <main class="relative flex-1 focus:outline-none">
            <div class="px-4 py-8 sm:px-6 lg:px-8 xl:py-10">
              <div
                class="md:flex md:items-center md:justify-between md:space-x-4"
              >
                <div>
                  <h1>Series</h1>
                  <p>Lorem ipsum</p>
                ...
                <ais-hits>
                  <template slot-scope="{ items }">
                    ...
                    >
                      <template #grid="{ item }">
                        <div
                          @click="redirect('/series/' + item.slugForUrl)"
...
export default {
  ...
  methods: {
    listViewStyleIs(style) {
      return this.listViewStyle === style;
    },
    redirect(url) {
  ...
  filters: {
    image(item) {
      ...
      return item.image
        ? item.image
        : `https://via.placeholder.com/1024x400?text=${name}`;
    }
  }
};
</script>

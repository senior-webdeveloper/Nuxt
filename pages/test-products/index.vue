        ...
        <div class="flex flex-col flex-1 w-0 overflow-hidden">
          <main class="relative flex-1 focus:outline-none">
            <div class="px-4 py-8 sm:px-6 lg:px-8 xl:py-10">
              ...
              <div class="mt-5">
                <div class="w-full p-4 bg-blueGray-100">
              ...
              <div class="mt-10">
                <ais-hits>
                  <template slot="item" slot-scope="{ item }">
                    <div @click="redirect('/test-products/' + item.slugForUrl)" class="cursor-pointer">
                      <h3>
                        <ais-highlight :hit="item" attribute="details.name" />
                      </h3>
                      <p class="truncate ...">{{ item.details.description }}</p>

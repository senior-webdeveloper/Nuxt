      ...
      <div class="absolute inset-x-0 z-10 mx-10 mt-3 transform shadow-lg" v-show="isOpen">
        <div class="bg-blueGray-100">
          <div class="grid px-4 py-6 mx-auto max-w-7xl gap-y-6 sm:grid-cols-2 sm:gap-8 sm:px-6 lg:grid-cols-4 lg:px-8">
            ...
            <NuxtLink to="/company-profile/america" class="flex flex-col justify-between p-3 -m-3 transition duration-300 ease-in-out rounded-lg hover:bg-gray-50">
              <div class="flex md:h-full lg:flex-col">
                <div class="flex-shrink-0">
                  <div class="flex-shrink-0">
                    <div class="items-center justify-center">
                      <div class="flex-shrink-0 hidden sm:block">
                        <img class="object-cover w-48 h-40 mx-auto rounded-md" src="https://nsk.nyc3.cdn.digitaloceanspaces.com/company-profile/nsk-america-th.png" alt="NSK headquarters in America">
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <NuxtLink to="/company-profile/japan" class="flex flex-col justify-between p-3 -m-3 transition duration-300 ease-in-out rounded-lg hover:bg-gray-50">
              <div class="flex md:h-full lg:flex-col">
                <div class="flex-shrink-0">
                  <div class="items-center justify-center">
                    <div class="flex-shrink-0 hidden sm:block">
                      <img class="object-cover w-48 h-40 mx-auto rounded-md" src="https://nsk.nyc3.cdn.digitaloceanspaces.com/company-profile/nsk-japan-th.png" alt="NSK headquarters in Japan">
                    </div>
                  </div>
                </div>
                <div class="ml-4 text-center md:flex-1 md:flex md:flex-col md:justify-between lg:ml-0 lg:mt-4">
